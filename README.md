...
|  12  | Финальный проект:<br> - A/B-тестирование<br> - Анализ для книжного стартапа (SQL) <br> \t - Поиск клиента с неоптимальными тарифами | [/12_Final_project](https://github.com/itstony-k/ya_praktikum/tree/master/12_Final_project) |
