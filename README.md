...
|  12  | Финальный проект: - A/B-тестирование - Анализ для книжного стартапа (SQL) - Поиск клиента с неоптимальными тарифами | [/12_Final_project](https://github.com/itstony-k/ya_praktikum/tree/master/12_Final_project) |
